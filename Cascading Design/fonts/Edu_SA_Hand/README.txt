...
This means all the styles are contained in a single file:
  Edu_SA_Hand/EduSAHand-VariableFont_wght.ttf

If your app fully supports variable fonts, you can now pick intermediate styles
that aren’t available as static fonts. Not all apps support variable fonts, and
in those cases you can use the static font files for Edu SA Hand:
  Edu_SA_Hand/static/EduSAHand-Regular.ttf
  Edu_SA_Hand/static/EduSAHand-Medium.ttf
  Edu_SA_Hand/static/EduSAHand-SemiBold.ttf
  Edu_SA_Hand/static/EduSAHand-Bold.ttf
